...
function watchRendererStyles() {
  return watch(['app/renderer/**/*.scss'], series(scripts.developStyles, hotreload.reload));
}
...
exports.start = series(
  ...
  scripts.developStyles,
  hotreload.start,
  electron.start,
  parallel(watchMainScripts, watchRendererScripts, watchRendererStyles, watchHtml),
);
